...
* Lacuna identificada: as funcionalidades de busca avançada e chat foram
  construídas fora do fluxo estrito de SDD desta documentação (sem SPEC/ADR
  dedicados) — registrado como aprendizado na apresentação (seção V.7).
